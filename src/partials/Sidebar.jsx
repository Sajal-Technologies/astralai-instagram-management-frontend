        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("instagram") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  ...
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes("instagram") && "hover:text-slate-200"
                  }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname.includes("instagram") && "text-indigo-300"
                        }`}
                        d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                      />
                      <path
                        className={`fill-current text-slate-700 ${
                          pathname.includes("instagram") && "!text-indigo-600"
                        }`}
                        d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                      />
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname.includes("instagram") && "text-indigo-500"
                        }`}
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("message-templates") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  ...
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes("message-templates") &&
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("message-history") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/message-history"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes("message-history") && "hover:text-slate-200"
                  }`}
                >
                  <div className="flex items-center">
                  <svg
                            ...
                            >
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("message-history") &&
                                  "text-indigo-500"
                                }`}
